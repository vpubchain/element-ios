...
-(void)setupCellWithRowData:(YXWalletMyWalletRecordsItem *)rowData{
    ...
    _countLabel.text = [NSString stringWithFormat:@"%@ %@",[NSString stringWithFormat:@"%.4f", rowData.balance.totalAmount/100000000],rowData.baseSymbol];//余额
    
    _numLabel.text = [NSString stringWithFormat:@"≈￥%.2f",rowData.fundValue.floatValue * rowData.balance.totalAmount/100000000];
